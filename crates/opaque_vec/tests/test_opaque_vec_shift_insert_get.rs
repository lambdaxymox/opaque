...
fn run_test_opaque_vec_shift_insert_get<T>(values: &[T])
where
...
fn run_test_opaque_vec_shift_insert_get_values<T>(values: &[T])
where
    T: PartialEq + Clone + fmt::Debug + 'static,
{
    for len in 0..values.len() {
        let prefix_values = &values[0..len];
        run_test_opaque_vec_shift_insert_get(prefix_values);
    }
}
...
macro_rules! generate_tests {
    ($typ:ident, $max_array_size:expr, $range_spec:expr, $alt_spec:expr) => {
        mod $typ {
            ...
            #[test]
            fn test_opaque_vec_shift_insert_get_range_values() {
                let values = ag::range_values::<$typ, $max_array_size>($range_spec);
                run_test_opaque_vec_shift_insert_get_values(&values);
            }

            #[test]
            fn test_opaque_vec_shift_insert_get_alternating_values() {
...
/*
#[test]
fn test_opaque_vec_shift_insert_get1() {
    let values = nonnegative_integer_values::<1>();

    run_test_opaque_vec_shift_insert_get(&values);
}

#[test]
fn test_opaque_vec_shift_insert_get2() {
...
#[test]
fn test_opaque_vec_shift_insert_get3() {
...
#[test]
fn test_opaque_vec_shift_insert_get4() {
...
#[test]
fn test_opaque_vec_shift_insert_get5() {
...
#[test]
fn test_opaque_vec_shift_insert_get6() {
...
#[test]
fn test_opaque_vec_shift_insert_get7() {
...
#[test]
fn test_opaque_vec_shift_insert_get8() {
...
#[test]
fn test_opaque_vec_shift_insert_get9() {
...
#[test]
fn test_opaque_vec_shift_insert_get10() {
...
#[test]
fn test_opaque_vec_shift_insert_get11() {
...
#[test]
fn test_opaque_vec_shift_insert_get12() {
...
#[test]
fn test_opaque_vec_shift_insert_get13() {
...
#[test]
fn test_opaque_vec_shift_insert_get14() {
...
#[test]
fn test_opaque_vec_shift_insert_get15() {
...
#[test]
fn test_opaque_vec_shift_insert_get16() {
...
#[test]
fn test_opaque_vec_shift_insert_get32() {
...
#[test]
fn test_opaque_vec_shift_insert_get64() {
