...
macro_rules! generate_props {
    ($module_name:ident, $typ:ty, $max_length:expr, $vec_gen:ident) => {
        mod $module_name {
            ...
            proptest! {
                #[test]
                fn prop_truncate_as_slice_length_greater_than_or_equal_to(values in super::$vec_gen::<$typ, alloc::Global>($max_length)) {
                    let values: super::OpaqueVec = values;
                    super::prop_truncate_as_slice_length_greater_than_or_equal_to::<$typ, alloc::Global>(values)?
                }

                #[test]
                fn prop_truncate_as_slice_length_less_than_or_equal_to(values in super::$vec_gen::<$typ, alloc::Global>($max_length)) {
                    let values: super::OpaqueVec = values;
                    super::prop_truncate_as_slice_length_less_than_or_equal_to::<$typ, alloc::Global>(values)?
                }

                #[test]
                fn prop_truncate_len_length_greater_than_or_equal_to(values in super::$vec_gen::<$typ, alloc::Global>($max_length)) {
                    let values: super::OpaqueVec = values;
                    super::prop_truncate_len_length_greater_than_or_equal_to::<$typ, alloc::Global>(values)?
                }

                #[test]
                fn prop_truncate_len_length_less_than_or_equal_to(values in super::$vec_gen::<$typ, alloc::Global>($max_length)) {
                    let values: super::OpaqueVec = values;
                    super::prop_truncate_len_length_less_than_or_equal_to::<$typ, alloc::Global>(values)?
                }
            }
        }
    };
