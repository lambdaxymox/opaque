        ...
        mod $module_name {
            ...
            proptest! {
                ...
                fn prop_shift_insert_contains_same_index1(
                    ...
                    super::prop_shift_insert_contains_same_index1::<$typ, alloc::Global>(value, alloc)?
                }
                ...
                fn prop_shift_insert_contains_same_index2(values in super::$vec_gen::<$typ, alloc::Global>($max_length)) {
                    ...
                    super::prop_shift_insert_contains_same_index2::<$typ, alloc::Global>(values)?
                }
            }
        }
    };
...
generate_props!(unit, (), 128, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(u8, u8, 128, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(u16, u16, 128, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(u32, u32, 128, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(u64, u64, 128, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(usize, usize, 128, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(string, String, 128, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
