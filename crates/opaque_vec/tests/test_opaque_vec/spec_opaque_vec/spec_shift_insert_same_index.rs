...
generate_props!(unit, (), alloc::Global, 32, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(u8, u8, alloc::Global, 32, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(u16, u16, alloc::Global, 32, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(u32, u32, alloc::Global, 32, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(u64, u64, alloc::Global, 32, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(usize, usize, alloc::Global, 32, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
generate_props!(string, String, alloc::Global, 32, strategy_type_erased_vec_max_len, strategy_single_value, strategy_alloc);
