...
fn run_test_opaque_vec_truncate_drop_to_zero_direct_range<A>(max_length: usize)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
    let alloc = A::default();
...
fn run_test_opaque_vec_truncate_drop_to_zero_steps_range<A>(max_length: usize)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
    let alloc = A::default();
...
fn run_test_opaque_vec_truncate_drop_to_length_range<A>(max_length: usize)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
    let alloc = A::default();
...
fn run_test_opaque_vec_truncate_drop_to_above_length_range<A>(max_length: usize)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
    let alloc = A::default();
...
fn test_opaque_vec_truncate_drop_to_zero_direct_range() {
    let max_length = 128;
    run_test_opaque_vec_truncate_drop_to_zero_direct_range::<alloc::Global>(max_length);
}

#[test]
fn test_opaque_vec_truncate_drop_to_zero_steps_range() {
    let max_length = 128;
    run_test_opaque_vec_truncate_drop_to_zero_steps_range::<alloc::Global>(max_length);
}

#[test]
fn test_opaque_vec_truncate_drop_to_length() {
    let max_length = 128;
    run_test_opaque_vec_truncate_drop_to_length_range::<alloc::Global>(max_length);
}

#[test]
fn test_opaque_vec_truncate_drop_to_above_length() {
    let max_length = 128;
    run_test_opaque_vec_truncate_drop_to_above_length_range::<alloc::Global>(max_length);
}
