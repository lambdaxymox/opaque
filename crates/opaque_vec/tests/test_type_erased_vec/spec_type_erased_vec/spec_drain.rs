...
fn strategy_prop_drain_partial_vec<T, A>(max_length: usize, max_count: usize) -> impl Strategy<Value = (TypeErasedVec, T, usize, usize)>
where
...
fn prop_drain_partial_vec<T, A>((values, drain_value, count, index): (TypeErasedVec, T, usize, usize)) -> Result<(), TestCaseError>
where
    T: any::Any + PartialEq + Clone + Default + fmt::Debug,
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default + fmt::Debug,
{
