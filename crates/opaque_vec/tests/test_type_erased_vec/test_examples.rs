...
fn test_type_erased_vec_slice_from_ref() {
    ...
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[0..1], &[1]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[1..2], &[2]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[2..3], &[3]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[3..4], &[4]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[4..5], &[5]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[5..6], &[6]);

    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[0..2], &[1, 2]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[1..3], &[2, 3]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[2..4], &[3, 4]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[3..5], &[4, 5]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[4..6], &[5, 6]);

    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[0..3], &[1, 2, 3]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[1..4], &[2, 3, 4]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[2..5], &[3, 4, 5]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[3..6], &[4, 5, 6]);

    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[0..4], &[1, 2, 3, 4]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[1..5], &[2, 3, 4, 5]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[2..6], &[3, 4, 5, 6]);

    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[0..5], &[1, 2, 3, 4, 5]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[1..6], &[2, 3, 4, 5, 6]);

    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[0..6], &[1, 2, 3, 4, 5, 6]);
    assert_eq!(&vec.as_slice::<i32, alloc::Global>()[..], &[1, 2, 3, 4, 5, 6]);
    assert_eq!(vec.as_slice::<i32, alloc::Global>(), &[1, 2, 3, 4, 5, 6]);
}
...
fn test_type_erased_vec_dedup() {
    ...
    test_case(TypeErasedVec::from(&[1]), TypeErasedVec::from(&[1]));
    test_case(TypeErasedVec::from(&[1, 1]), TypeErasedVec::from(&[1]));
    test_case(TypeErasedVec::from(&[1, 2, 3]), TypeErasedVec::from(&[1, 2, 3]));
    test_case(TypeErasedVec::from(&[1, 1, 2, 3]), TypeErasedVec::from(&[1, 2, 3]));
    test_case(TypeErasedVec::from(&[1, 2, 2, 3]), TypeErasedVec::from(&[1, 2, 3]));
    test_case(TypeErasedVec::from(&[1, 2, 3, 3]), TypeErasedVec::from(&[1, 2, 3]));
    test_case(TypeErasedVec::from(&[1, 1, 2, 2, 2, 3, 3]), TypeErasedVec::from(&[1, 2, 3]));
    test_case(TypeErasedVec::from(&[1, 1, 2, 2, 2, 3, 3, 4, 5, 5, 5, 6, 7, 7]), TypeErasedVec::from(&[1, 2, 3, 4, 5, 6, 7]));
}
...
fn test_type_erased_vec_dedup_by_key() {
    ...
    test_case(TypeErasedVec::new::<i32>(), TypeErasedVec::new::<i32>());
    test_case(TypeErasedVec::from(&[10]), TypeErasedVec::from(&[10]));
    test_case(TypeErasedVec::from(&[10, 11]), TypeErasedVec::from(&[10]));
    test_case(TypeErasedVec::from(&[10, 20, 30]), TypeErasedVec::from(&[10, 20, 30]));
    test_case(TypeErasedVec::from(&[10, 11, 20, 30]), TypeErasedVec::from(&[10, 20, 30]));
    test_case(TypeErasedVec::from(&[10, 20, 21, 30]), TypeErasedVec::from(&[10, 20, 30]));
    test_case(TypeErasedVec::from(&[10, 20, 30, 31]), TypeErasedVec::from(&[10, 20, 30]));
    test_case(TypeErasedVec::from(&[10, 11, 20, 21, 22, 30, 31]), TypeErasedVec::from(&[10, 20, 30]));
}
...
fn test_type_erased_vec_truncate_drop1() {
    ...
    let mut vec = TypeErasedVec::from([Value::new(1)]);
...
fn test_type_erased_vec_retain2() {
    let mut vec = TypeErasedVec::from([1_i32, 2_i32, 3_i32, 4_i32, 5_i32, 6_i32]);
    vec.retain::<_, i32, alloc::Global>(|&x| true);
...
fn test_type_erased_vec_retain3() {
    let mut vec = TypeErasedVec::from([1_i32, 2_i32, 3_i32, 4_i32, 5_i32, 6_i32]);
    vec.retain::<_, i32, alloc::Global>(|&x| false);
