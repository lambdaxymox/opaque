...
generate_tests!(i16, 128, opaque_testing::RangeValuesSpec::new(0), opaque_testing::AlternatingValuesSpec::new(i16::MIN, 0));
generate_tests!(i32, 128, opaque_testing::RangeValuesSpec::new(0), opaque_testing::AlternatingValuesSpec::new(i32::MIN, 0));
generate_tests!(i64, 128, opaque_testing::RangeValuesSpec::new(0), opaque_testing::AlternatingValuesSpec::new(i64::MIN, 0));
generate_tests!(i128, 128, opaque_testing::RangeValuesSpec::new(0), opaque_testing::AlternatingValuesSpec::new(i128::MIN, 0));
generate_tests!(
    isize,
    128,
