...
fn run_test_opaque_vec_shift_remove_end<T>(values: &[T])
where
...
fn run_test_opaque_vec_shift_remove_end_values<T>(values: &[T])
where
    T: PartialEq + Clone + fmt::Debug + 'static,
{
    for len in 1..values.len() {
        let prefix_values = &values[0..len];
        run_test_opaque_vec_shift_remove_end(prefix_values);
    }
}
    ...
    ($typ:ident, $max_array_size:expr, $range_spec:expr, $alt_spec:expr) => {
        mod $typ {
            ...
            fn test_opaque_vec_shift_remove_end_range_values() {
                ...
                run_test_opaque_vec_shift_remove_end_values(&values);
            }
...
generate_tests!(i16, 128, opaque_vec_testing::RangeValuesSpec::new(0), opaque_vec_testing::AlternatingValuesSpec::new(i16::MIN, 0));
generate_tests!(i32, 128, opaque_vec_testing::RangeValuesSpec::new(0), opaque_vec_testing::AlternatingValuesSpec::new(i32::MIN, 0));
generate_tests!(i64, 128, opaque_vec_testing::RangeValuesSpec::new(0), opaque_vec_testing::AlternatingValuesSpec::new(i64::MIN, 0));
generate_tests!(i128, 128, opaque_vec_testing::RangeValuesSpec::new(0), opaque_vec_testing::AlternatingValuesSpec::new(i128::MIN, 0));
generate_tests!(
    isize,
    128,
