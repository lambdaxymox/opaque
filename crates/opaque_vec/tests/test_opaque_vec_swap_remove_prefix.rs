...
fn run_test_opaque_vec_swap_remove_from_end<T>(values: &[T])
where
...
fn run_test_opaque_vec_swap_remove_from_end_values<T>(values: &[T])
where
    T: PartialEq + Clone + fmt::Debug + 'static,
{
    for len in 1..values.len() {
        let prefix_values = &values[0..len];
        run_test_opaque_vec_swap_remove_from_end(prefix_values);
    }
}
...
macro_rules! generate_tests {
    ($typ:ident, $max_array_size:expr, $range_spec:expr, $alt_spec:expr) => {
        mod $typ {
            ...
            #[test]
            fn test_opaque_vec_swap_remove_from_end_range_values() {
                let values = ag::range_values::<$typ, $max_array_size>($range_spec);
                run_test_opaque_vec_swap_remove_from_end_values(&values);
            }

            #[test]
            fn test_opaque_vec_swap_remove_from_end_alternating_values() {
...
/*
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder1() {
    let values = nonnegative_integer_values::<1>();

    run_test_opaque_vec_swap_remove_from_end_does_not_change_remainder(&values);
}

#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder2() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder3() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder4() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder5() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder6() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder7() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder8() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder9() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder10() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder11() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder12() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder13() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder14() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder15() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder16() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder32() {
...
#[test]
fn test_opaque_vec_swap_remove_from_end_does_not_change_remainder64() {
