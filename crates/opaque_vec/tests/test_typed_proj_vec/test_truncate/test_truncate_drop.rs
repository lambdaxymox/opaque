...
fn run_test_typed_proj_vec_truncate_drop_to_zero_direct<A>(length: usize, alloc: A)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
...
fn run_test_typed_proj_vec_truncate_drop_to_zero_steps<A>(length: usize, alloc: A)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
    let (drop_counter, mut vec) = create_drop_counter_vec_in(length, alloc);
...
fn run_test_typed_proj_vec_truncate_drop_to_length<A>(length: usize, alloc: A)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
    let (drop_counter, mut vec) = create_drop_counter_vec_in(length, alloc);
...
fn run_test_typed_proj_vec_truncate_drop_to_above_length<A>(length: usize, alloc: A)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
    let (drop_counter, mut vec) = create_drop_counter_vec_in(length, alloc);
...
fn run_test_typed_proj_vec_truncate_drop_to_zero_steps_range<A>(max_length: usize)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
    let alloc = A::default();
...
fn run_test_typed_proj_vec_truncate_drop_to_length_range<A>(max_length: usize)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
    let alloc = A::default();
...
fn run_test_typed_proj_vec_truncate_drop_to_above_length_range<A>(max_length: usize)
where
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default,
{
    let alloc = A::default();
