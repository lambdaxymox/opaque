...
macro_rules! generate_props {
    ($module_name:ident, $typ:ty, $max_length:expr, $vec_gen:ident, $nonempty_vec_gen:ident) => {
        mod $module_name {
            ...
            proptest! {
                #[test]
                fn prop_shift_remove_end(values in super::$nonempty_vec_gen::<$typ, alloc::Global>($max_length)) {
                    let values: super::TypedProjVec<$typ, alloc::Global> = values;
                    super::prop_shift_remove_end(values)?
                }

                #[test]
                fn prop_shift_remove_start(values in super::$vec_gen::<$typ, alloc::Global>($max_length)) {
                    let values: super::TypedProjVec<$typ, alloc::Global> = values;
                    super::prop_shift_remove_start(values)?
                }

                #[test]
                fn prop_shift_remove_get_from_end(values in super::$vec_gen::<$typ, alloc::Global>($max_length)) {
                    let values: super::TypedProjVec<$typ, alloc::Global> = values;
                    super::prop_shift_remove_get_from_end(values)?
                }

                #[test]
                fn prop_shift_remove_len(values in super::$vec_gen::<$typ, alloc::Global>($max_length)) {
                    let values: super::TypedProjVec<$typ, alloc::Global> = values;
...
generate_props!(unit, (), 128, strategy_type_projected_vec_max_len, strategy_type_projected_vec_max_len_nonempty);
generate_props!(u8, u8, 128, strategy_type_projected_vec_max_len, strategy_type_projected_vec_max_len_nonempty);
generate_props!(u16, u16, 128, strategy_type_projected_vec_max_len, strategy_type_projected_vec_max_len_nonempty);
generate_props!(u32, u32, 128, strategy_type_projected_vec_max_len, strategy_type_projected_vec_max_len_nonempty);
generate_props!(u64, u64, 128, strategy_type_projected_vec_max_len, strategy_type_projected_vec_max_len_nonempty);
generate_props!(usize, usize, 128, strategy_type_projected_vec_max_len, strategy_type_projected_vec_max_len_nonempty);
generate_props!(string, String, 128, strategy_type_projected_vec_max_len, strategy_type_projected_vec_max_len_nonempty);
