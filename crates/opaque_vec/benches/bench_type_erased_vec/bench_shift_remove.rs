...
fn bench_type_erased_vec_shift_remove_last(c: &mut Criterion) {
    let dummy_data = 0_i32;
...
criterion_group!(bench_shift_remove, bench_type_erased_vec_shift_remove_last, bench_vec_shift_remove_last);
