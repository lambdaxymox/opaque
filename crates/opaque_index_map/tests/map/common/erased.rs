...
use crate::map::common::projected::strategy_type_projected_index_map_len;
    ...
    A: any::Any + alloc::Allocator + Send + Sync + Clone + Default + fmt::Debug,
{
    ...
    clamped_interval(max_length).prop_flat_map(move |length| strategy_type_erased_index_map_len::<K, V, S, A>(length))
}
