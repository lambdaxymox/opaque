...
fn prop_insert_full_preserves_order_new_entry<K, V, S, A>((entries, new_entry): (OpaqueIndexMap, (K, V))) -> Result<(), TestCaseError>
where
...
macro_rules! generate_props {
    (
        ...
        mod $module_name {
            ...
            proptest! {
                #[test]
                fn prop_insert_full_preserves_order_new_entry(
                    ...
                    super::prop_insert_full_preserves_order_new_entry::<$key_typ, $value_typ, $build_hasher_typ, $alloc_typ>((entries, new_entry))?
                }
            }
        }
    };
