...
fn strategy_prop_insert_preserves_order_new_entry<K, V, S, A>(max_length: usize) -> impl Strategy<Value = (TypeErasedIndexMap, (K, V))>
where
...
fn prop_insert_preserves_order_new_entry<K, V, S, A>((entries, new_entry): (TypeErasedIndexMap, (K, V))) -> Result<(), TestCaseError>
where
