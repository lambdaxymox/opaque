...
fn prop_shift_remove_contains_key<K, V, S, A>(entries: OpaqueIndexMap) -> Result<(), TestCaseError>
where
...
fn prop_shift_remove_get<K, V, S, A>(entries: OpaqueIndexMap) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_shift_remove_get_key_value<K, V, S, A>(entries: OpaqueIndexMap) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_shift_remove_get_mut<K, V, S, A>(entries: OpaqueIndexMap) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_shift_remove_len<K, V, S, A>(entries: OpaqueIndexMap) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_shift_remove_preserves_order<K, V, S, A>(entries: OpaqueIndexMap) -> Result<(), TestCaseError>
where
