...
fn test_truncate_on_panic_drop_count1() {
    ...
    let mut map = TypeErasedIndexMap::new::<usize, PanicCell<()>>();
    ...
    let result = panic::catch_unwind(AssertUnwindSafe(|| {
        map.truncate::<usize, PanicCell<()>, hash::RandomState, alloc::Global>(0);
    }));
...
fn test_truncate_on_panic_drop_count2() {
    ...
    map.truncate::<usize, PanicCell<()>, hash::RandomState, alloc::Global>(1);
...
fn test_truncate_on_panic_drop_count3() {
    ...
    map.truncate::<usize, PanicCell<()>, hash::RandomState, alloc::Global>(2);
