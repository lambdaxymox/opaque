...
fn run_test_opaque_index_map_append_get_index_of_source<K, V, S1, S2, A>(
    values1: &[(K, V)],
    values2: &[(K, V)],
    build_hasher1: S1,
    build_hasher2: S2,
...
fn run_test_opaque_index_map_append_get_index_of_source_values<K, V, S1, S2, A>(
    values1: &[(K, V)],
    values2: &[(K, V)],
    build_hasher1: S1,
    build_hasher2: S2,
    ...
    (
        ...
        mod $module_name {
            ...
            fn run_test_opaque_index_map_append_get_index_of_source_empty() {
                ...
                run_test_opaque_index_map_append_get_index_of_source_values(&values1, &values2, build_hasher1, build_hasher2, alloc);
            }
