    ...
    ($module_name:ident, $key_typ:ty, $value_typ:ty, $build_hasher_typ:ty, $alloc_typ:ty) => {
        mod $module_name {
            ...
            fn test_type_erased_index_map_with_hasher_in_has_type() {
                ...
                run_test_type_erased_index_map_with_hasher_in_has_type::<$key_typ, $value_typ, $build_hasher_typ, $alloc_typ>(build_hasher, alloc);
            }
            ...
            fn test_type_erased_index_map_with_capacity_and_hasher_in_has_type() {
                let build_hasher: $build_hasher_typ = Default::default();
                let alloc: $alloc_typ = Default::default();
                run_test_type_erased_index_map_with_capacity_and_hasher_in_has_type::<$key_typ, $value_typ, $build_hasher_typ, $alloc_typ>(build_hasher, alloc);
            }
            ...
            fn test_type_erased_index_map_with_capacity_and_hasher_has_type() {
                let build_hasher: $build_hasher_typ = Default::default();
                run_test_type_erased_index_map_with_capacity_and_hasher_has_type::<$key_typ, $value_typ, $build_hasher_typ>(build_hasher);
            }
            #[test]
...
generate_tests!(i8_string_random_state_wrapping, i8, String, RandomState, WrappingAlloc<Global>);
generate_tests!(i8_box_any_random_state_global, i8, Box<dyn any::Any>, RandomState, Global);
generate_tests!(i8_box_any_random_state_wrapping, i8, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i16_isize_random_state_wrapping, i16, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i16_usize_random_state_wrapping, i16, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i16_string_random_state_wrapping, i16, String, RandomState, WrappingAlloc<Global>);
generate_tests!(i16_box_any_random_state_global, i16, Box<dyn any::Any>, RandomState, Global);
generate_tests!(i16_box_any_random_state_wrapping, i16, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i32_isize_random_state_wrapping, i32, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i32_usize_random_state_wrapping, i32, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i32_string_random_state_wrapping, i32, String, RandomState, WrappingAlloc<Global>);
generate_tests!(i32_box_any_random_state_global, i32, Box<dyn any::Any>, RandomState, Global);
generate_tests!(i32_box_any_random_state_wrapping, i32, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i64_isize_random_state_wrapping, i64, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i64_usize_random_state_wrapping, i64, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i64_string_random_state_wrapping, i64, String, RandomState, WrappingAlloc<Global>);
generate_tests!(i64_box_any_random_state_global, i64, Box<dyn any::Any>, RandomState, Global);
generate_tests!(i64_box_any_random_state_wrapping, i64, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i128_i128_random_state_wrapping, i128, i128, RandomState, WrappingAlloc<Global>);
generate_tests!(i128_isize_random_state_global, i128, isize, RandomState, Global);
generate_tests!(i128_isize_random_state_wrapping, i128, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i128_u128_random_state_wrapping, i128, u128, RandomState, WrappingAlloc<Global>);
generate_tests!(i128_usize_random_state_global, i128, usize, RandomState, Global);
generate_tests!(i128_usize_random_state_wrapping, i128, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(i128_bool_random_state_wrapping, i128, bool, RandomState, WrappingAlloc<Global>);
generate_tests!(i128_char_random_state_global, i128, char, RandomState, Global);
generate_tests!(i128_char_random_state_wrapping, i128, char, RandomState, WrappingAlloc<Global>);
generate_tests!(i128_string_random_state_global, i128, String, RandomState, Global);
generate_tests!(i128_string_random_state_wrapping, i128, String, RandomState, WrappingAlloc<Global>);
generate_tests!(i128_box_any_random_state_global, i128, Box<dyn any::Any>, RandomState, Global);
generate_tests!(i128_box_any_random_state_wrapping, i128, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(isize_i16_random_state_wrapping, isize, i16, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_i32_random_state_global, isize, i32, RandomState, Global);
generate_tests!(isize_i32_random_state_wrapping, isize, i32, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_i64_random_state_global, isize, i64, RandomState, Global);
generate_tests!(isize_i64_random_state_wrapping, isize, i64, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_i128_random_state_global, isize, i128, RandomState, Global);
generate_tests!(isize_i128_random_state_wrapping, isize, i128, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_isize_random_state_global, isize, isize, RandomState, Global);
generate_tests!(isize_isize_random_state_wrapping, isize, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(isize_u16_random_state_wrapping, isize, u16, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_u32_random_state_global, isize, u32, RandomState, Global);
generate_tests!(isize_u32_random_state_wrapping, isize, u32, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_u64_random_state_global, isize, u64, RandomState, Global);
generate_tests!(isize_u64_random_state_wrapping, isize, u64, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_u128_random_state_global, isize, u128, RandomState, Global);
generate_tests!(isize_u128_random_state_wrapping, isize, u128, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_usize_random_state_global, isize, usize, RandomState, Global);
generate_tests!(isize_usize_random_state_wrapping, isize, usize, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_f32_random_state_global, isize, f32, RandomState, Global);
generate_tests!(isize_f32_random_state_wrapping, isize, f32, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_f64_random_state_global, isize, f64, RandomState, Global);
generate_tests!(isize_f64_random_state_wrapping, isize, f64, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_bool_random_state_global, isize, bool, RandomState, Global);
generate_tests!(isize_bool_random_state_wrapping, isize, bool, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_char_random_state_global, isize, char, RandomState, Global);
generate_tests!(isize_char_random_state_wrapping, isize, char, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_string_random_state_global, isize, String, RandomState, Global);
generate_tests!(isize_string_random_state_wrapping, isize, String, RandomState, WrappingAlloc<Global>);
generate_tests!(isize_box_any_random_state_global, isize, Box<dyn any::Any>, RandomState, Global);
generate_tests!(isize_box_any_random_state_wrapping, isize, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u8_string_random_state_wrapping, u8, String, RandomState, WrappingAlloc<Global>);
generate_tests!(u8_box_any_random_state_global, u8, Box<dyn any::Any>, RandomState, Global);
generate_tests!(u8_box_any_random_state_wrapping, u8, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u16_isize_random_state_wrapping, u16, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u16_usize_random_state_wrapping, u16, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u16_string_random_state_wrapping, u16, String, RandomState, WrappingAlloc<Global>);
generate_tests!(u16_box_any_random_state_global, u16, Box<dyn any::Any>, RandomState, Global);
generate_tests!(u16_box_any_random_state_wrapping, u16, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u32_isize_random_state_wrapping, u32, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u32_usize_random_state_wrapping, u32, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u32_string_random_state_wrapping, u32, String, RandomState, WrappingAlloc<Global>);
generate_tests!(u32_box_any_random_state_global, u32, Box<dyn any::Any>, RandomState, Global);
generate_tests!(u32_box_any_random_state_wrapping, u32, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u64_isize_random_state_wrapping, u64, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u64_usize_random_state_wrapping, u64, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u64_string_random_state_wrapping, u64, String, RandomState, WrappingAlloc<Global>);
generate_tests!(u64_box_any_random_state_global, u64, Box<dyn any::Any>, RandomState, Global);
generate_tests!(u64_box_any_random_state_wrapping, u64, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u128_i128_random_state_wrapping, u128, i128, RandomState, WrappingAlloc<Global>);
generate_tests!(u128_isize_random_state_global, u128, isize, RandomState, Global);
generate_tests!(u128_isize_random_state_wrapping, u128, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u128_u128_random_state_wrapping, u128, u128, RandomState, WrappingAlloc<Global>);
generate_tests!(u128_usize_random_state_global, u128, usize, RandomState, Global);
generate_tests!(u128_usize_random_state_wrapping, u128, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(u128_bool_random_state_wrapping, u128, bool, RandomState, WrappingAlloc<Global>);
generate_tests!(u128_char_random_state_global, u128, char, RandomState, Global);
generate_tests!(u128_char_random_state_wrapping, u128, char, RandomState, WrappingAlloc<Global>);
generate_tests!(u128_string_random_state_global, u128, String, RandomState, Global);
generate_tests!(u128_string_random_state_wrapping, u128, String, RandomState, WrappingAlloc<Global>);
generate_tests!(u128_box_any_random_state_global, u128, Box<dyn any::Any>, RandomState, Global);
generate_tests!(u128_box_any_random_state_wrapping, u128, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(usize_i16_random_state_wrapping, usize, i16, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_i32_random_state_global, usize, i32, RandomState, Global);
generate_tests!(usize_i32_random_state_wrapping, usize, i32, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_i64_random_state_global, usize, i64, RandomState, Global);
generate_tests!(usize_i64_random_state_wrapping, usize, i64, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_i128_random_state_global, usize, i128, RandomState, Global);
generate_tests!(usize_i128_random_state_wrapping, usize, i128, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_isize_random_state_global, usize, isize, RandomState, Global);
generate_tests!(usize_isize_random_state_wrapping, usize, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(usize_u16_random_state_wrapping, usize, u16, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_u32_random_state_global, usize, u32, RandomState, Global);
generate_tests!(usize_u32_random_state_wrapping, usize, u32, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_u64_random_state_global, usize, u64, RandomState, Global);
generate_tests!(usize_u64_random_state_wrapping, usize, u64, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_u128_random_state_global, usize, u128, RandomState, Global);
generate_tests!(usize_u128_random_state_wrapping, usize, u128, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_usize_random_state_global, usize, usize, RandomState, Global);
generate_tests!(usize_usize_random_state_wrapping, usize, usize, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_f32_random_state_global, usize, f32, RandomState, Global);
generate_tests!(usize_f32_random_state_wrapping, usize, f32, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_f64_random_state_global, usize, f64, RandomState, Global);
generate_tests!(usize_f64_random_state_wrapping, usize, f64, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_bool_random_state_global, usize, bool, RandomState, Global);
generate_tests!(usize_bool_random_state_wrapping, usize, bool, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_char_random_state_global, usize, char, RandomState, Global);
generate_tests!(usize_char_random_state_wrapping, usize, char, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_string_random_state_global, usize, String, RandomState, Global);
generate_tests!(usize_string_random_state_wrapping, usize, String, RandomState, WrappingAlloc<Global>);
generate_tests!(usize_box_any_random_state_global, usize, Box<dyn any::Any>, RandomState, Global);
generate_tests!(usize_box_any_random_state_wrapping, usize, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(f32_isize_random_state_wrapping, f32, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(f32_usize_random_state_wrapping, f32, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(f32_string_random_state_wrapping, f32, String, RandomState, WrappingAlloc<Global>);
generate_tests!(f32_box_any_random_state_global, f32, Box<dyn any::Any>, RandomState, Global);
generate_tests!(f32_box_any_random_state_wrapping, f32, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(f64_isize_random_state_wrapping, f64, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(f64_usize_random_state_wrapping, f64, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(f64_string_random_state_wrapping, f64, String, RandomState, WrappingAlloc<Global>);
generate_tests!(f64_box_any_random_state_global, f64, Box<dyn any::Any>, RandomState, Global);
generate_tests!(f64_box_any_random_state_wrapping, f64, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(bool_i128_random_state_wrapping, bool, i128, RandomState, WrappingAlloc<Global>);
generate_tests!(bool_isize_random_state_global, bool, isize, RandomState, Global);
generate_tests!(bool_isize_random_state_wrapping, bool, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(bool_u128_random_state_wrapping, bool, u128, RandomState, WrappingAlloc<Global>);
generate_tests!(bool_usize_random_state_global, bool, usize, RandomState, Global);
generate_tests!(bool_usize_random_state_wrapping, bool, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(bool_bool_random_state_wrapping, bool, bool, RandomState, WrappingAlloc<Global>);
generate_tests!(bool_char_random_state_global, bool, char, RandomState, Global);
generate_tests!(bool_char_random_state_wrapping, bool, char, RandomState, WrappingAlloc<Global>);
generate_tests!(bool_string_random_state_global, bool, String, RandomState, Global);
generate_tests!(bool_string_random_state_wrapping, bool, String, RandomState, WrappingAlloc<Global>);
generate_tests!(bool_box_any_random_state_global, bool, Box<dyn any::Any>, RandomState, Global);
generate_tests!(bool_box_any_random_state_wrapping, bool, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
...
generate_tests!(char_i128_random_state_wrapping, char, i128, RandomState, WrappingAlloc<Global>);
generate_tests!(char_isize_random_state_global, char, isize, RandomState, Global);
generate_tests!(char_isize_random_state_wrapping, char, isize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(char_u128_random_state_wrapping, char, u128, RandomState, WrappingAlloc<Global>);
generate_tests!(char_usize_random_state_global, char, usize, RandomState, Global);
generate_tests!(char_usize_random_state_wrapping, char, usize, RandomState, WrappingAlloc<Global>);
...
generate_tests!(char_bool_random_state_wrapping, char, bool, RandomState, WrappingAlloc<Global>);
generate_tests!(char_char_random_state_global, char, char, RandomState, Global);
generate_tests!(char_char_random_state_wrapping, char, char, RandomState, WrappingAlloc<Global>);
generate_tests!(char_string_random_state_global, char, String, RandomState, Global);
generate_tests!(char_string_random_state_wrapping, char, String, RandomState, WrappingAlloc<Global>);
generate_tests!(char_box_any_random_state_global, char, Box<dyn any::Any>, RandomState, Global);
generate_tests!(char_box_any_random_state_wrapping, char, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);

generate_tests!(string_i8_random_state_global, String, i8, RandomState, Global);
generate_tests!(string_i8_random_state_wrapping, String, i8, RandomState, WrappingAlloc<Global>);
generate_tests!(string_i16_random_state_global, String, i16, RandomState, Global);
generate_tests!(string_i16_random_state_wrapping, String, i16, RandomState, WrappingAlloc<Global>);
generate_tests!(string_i32_random_state_global, String, i32, RandomState, Global);
generate_tests!(string_i32_random_state_wrapping, String, i32, RandomState, WrappingAlloc<Global>);
generate_tests!(string_i64_random_state_global, String, i64, RandomState, Global);
generate_tests!(string_i64_random_state_wrapping, String, i64, RandomState, WrappingAlloc<Global>);
generate_tests!(string_i128_random_state_global, String, i128, RandomState, Global);
generate_tests!(string_i128_random_state_wrapping, String, i128, RandomState, WrappingAlloc<Global>);
generate_tests!(string_isize_random_state_global, String, isize, RandomState, Global);
generate_tests!(string_isize_random_state_wrapping, String, isize, RandomState, WrappingAlloc<Global>);
generate_tests!(string_u8_random_state_global, String, u8, RandomState, Global);
generate_tests!(string_u8_random_state_wrapping, String, u8, RandomState, WrappingAlloc<Global>);
generate_tests!(string_u16_random_state_global, String, u16, RandomState, Global);
generate_tests!(string_u16_random_state_wrapping, String, u16, RandomState, WrappingAlloc<Global>);
generate_tests!(string_u32_random_state_global, String, u32, RandomState, Global);
generate_tests!(string_u32_random_state_wrapping, String, u32, RandomState, WrappingAlloc<Global>);
generate_tests!(string_u64_random_state_global, String, u64, RandomState, Global);
generate_tests!(string_u64_random_state_wrapping, String, u64, RandomState, WrappingAlloc<Global>);
generate_tests!(string_u128_random_state_global, String, u128, RandomState, Global);
generate_tests!(string_u128_random_state_wrapping, String, u128, RandomState, WrappingAlloc<Global>);
generate_tests!(string_usize_random_state_global, String, usize, RandomState, Global);
generate_tests!(string_usize_random_state_wrapping, String, usize, RandomState, WrappingAlloc<Global>);
generate_tests!(string_f32_random_state_global, String, f32, RandomState, Global);
generate_tests!(string_f32_random_state_wrapping, String, f32, RandomState, WrappingAlloc<Global>);
generate_tests!(string_f64_random_state_global, String, f64, RandomState, Global);
generate_tests!(string_f64_random_state_wrapping, String, f64, RandomState, WrappingAlloc<Global>);
generate_tests!(string_bool_random_state_global, String, bool, RandomState, Global);
generate_tests!(string_bool_random_state_wrapping, String, bool, RandomState, WrappingAlloc<Global>);
generate_tests!(string_char_random_state_global, String, char, RandomState, Global);
generate_tests!(string_char_random_state_wrapping, String, char, RandomState, WrappingAlloc<Global>);
generate_tests!(string_string_random_state_global, String, String, RandomState, Global);
generate_tests!(string_string_random_state_wrapping, String, String, RandomState, WrappingAlloc<Global>);
generate_tests!(string_box_any_random_state_global, String, Box<dyn any::Any>, RandomState, Global);
generate_tests!(string_box_any_random_state_wrapping, String, Box<dyn any::Any>, RandomState, WrappingAlloc<Global>);
