...
fn from_entries_insert_in<K, V, S, A>(entries: &TypedProjIndexMap<K, V, S, A>) -> TypedProjIndexMap<K, V, S, A>
where
...
{
    let mut map: TypedProjIndexMap<K, V, S, A> = TypedProjIndexMap::with_hasher_proj_in(
...
fn prop_insert_as_mut_slice<K, V, S, A>(mut entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_as_slice<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_contains_key<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    ...
    A: any::Any + alloc::Allocator + Send + Sync + Clone,
{
    let mut map = TypedProjIndexMap::with_hasher_proj_in(
        entries.hasher().clone(),
        entries.allocator().clone()
    );
...
fn prop_insert_get<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_get_full<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_get_mut<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_get_full_mut<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_get_index_of<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_get_key_value<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_iter<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_iter_mut<K, V, S, A>(mut entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_len<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
...
fn prop_insert_values<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
...
fn prop_insert_values_mut<K, V, S, A>(mut entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + Ord + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
        ...
        mod $module_name {
            ...
            proptest! {
                ...
                fn prop_insert_as_mut_slice(entries in super::$map_gen::<$key_typ, $value_typ, $build_hasher_typ, $alloc_typ>($max_length)) {
                    ...
                    super::prop_insert_as_mut_slice(entries)?
                }
                ...
                fn prop_insert_contains_key(entries in super::$map_gen::<$key_typ, $value_typ, $build_hasher_typ, $alloc_typ>($max_length)) {
                    let entries: super::TypedProjIndexMap<$key_typ, $value_typ, $build_hasher_typ, $alloc_typ> = entries;
                    super::prop_insert_contains_key(entries)?
                }
                ...
                fn prop_insert_get_key_value(entries in super::$map_gen::<$key_typ, $value_typ, $build_hasher_typ, $alloc_typ>($max_length)) {
                    let entries: super::TypedProjIndexMap<$key_typ, $value_typ, $build_hasher_typ, $alloc_typ> = entries;
                    super::prop_insert_get_key_value(entries)?
                }
                ...
                fn prop_insert_iter_mut(entries in super::$map_gen::<$key_typ, $value_typ, $build_hasher_typ, $alloc_typ>($max_length)) {
                    let entries: super::TypedProjIndexMap<$key_typ, $value_typ, $build_hasher_typ, $alloc_typ> = entries;
                    super::prop_insert_iter_mut(entries)?
                }
