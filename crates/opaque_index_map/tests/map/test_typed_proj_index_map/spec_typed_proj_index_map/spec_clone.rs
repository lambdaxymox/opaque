...
fn prop_clone<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
...
fn prop_clone_len<K, V, S, A>(entries: TypedProjIndexMap<K, V, S, A>) -> Result<(), TestCaseError>
where
    K: any::Any + Clone + Eq + hash::Hash + fmt::Debug,
    V: any::Any + Clone + Eq + fmt::Debug,
    S: any::Any + hash::BuildHasher + Send + Sync + Clone,
