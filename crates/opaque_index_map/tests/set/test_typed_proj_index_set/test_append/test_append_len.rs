...
fn run_test_typed_proj_index_set_append_len_source<T, S1, A1, S2, A2>(
    values1: &[T],
    values2: &[T],
    build_hasher1: S1,
    alloc1: A1,
...
fn run_test_typed_proj_index_set_append_len_destination<T, S1, A1, S2, A2>(
    values1: &[T],
    values2: &[T],
    build_hasher1: S1,
    alloc1: A1,
...
fn run_test_typed_proj_index_set_append_len_source_values<T, S1, A1, S2, A2>(
    values1: &[T],
    values2: &[T],
    build_hasher1: S1,
    alloc1: A1,
...
fn run_test_typed_proj_index_set_append_len_destination_values<T, S1, A1, S2, A2>(
    values1: &[T],
    values2: &[T],
    build_hasher1: S1,
    alloc1: A1,
    ...
    ($module_name:ident, value_type = $value_typ:ty, src_range_spec = $src_range_spec:expr, dst_range_spec = $dst_range_spec:expr) => {
        mod $module_name {
            ...
            fn run_test_typed_proj_index_set_append_len_source_empty() {
                ...
                run_test_typed_proj_index_set_append_len_source_values(&values1, &values2, build_hasher1, alloc1, build_hasher2, alloc2);
            }
            ...
            fn run_test_typed_proj_index_set_append_len_destination_empty() {
                ...
                let build_hasher2 = hash::RandomState::new();
                let alloc2 = common::typed_proj_index_set::WrappingAlloc2::new(alloc::Global);
                run_test_typed_proj_index_set_append_len_destination_values(&values1, &values2, build_hasher1, alloc1, build_hasher2, alloc2);
            }
