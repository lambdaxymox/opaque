use crate::set::common::erased::strategy_type_erased_index_set_max_len_nonempty;
...
fn strategy_prop_insert_full_preserves_order_new_entry<T, S, A>(max_length: usize) -> impl Strategy<Value = (OpaqueIndexSet, T)>
where
...
fn prop_insert_full_preserves_order_new_entry<T, S, A>((entries, new_entry): (OpaqueIndexSet, T)) -> Result<(), TestCaseError>
where
        ...
        mod $module_name {
            ...
            proptest! {
                ...
                fn prop_insert_full_preserves_order_new_entry((entries, new_entry) in super::$set_gen::<$value_typ, $build_hasher_typ, $alloc_typ>($max_length)) {
                    ...
                    super::prop_insert_full_preserves_order_new_entry::<$value_typ, $build_hasher_typ, $alloc_typ>((entries, new_entry))?
                }
            }
        }
    };
