...
fn from_symmetric_difference_in<T, S1, S2, A>(entries1: &TypeErasedIndexSet, entries2: &TypeErasedIndexSet) -> TypeErasedIndexSet
where
...
{
    let lhs =
        from_symmetric_difference_in::<T, S1, S2, A>(&entries1, &from_intersection_in::<T, S2, S3, A>(&entries2, &entries3));
    let rhs = from_intersection_in::<T, S1, S1, A>(
        &from_symmetric_difference_in::<T, S1, S2, A>(&entries1, &entries2),
        &from_symmetric_difference_in::<T, S1, S3, A>(&entries1, &entries3),
    );
        ...
        mod $module_name {
            ...
            proptest! {
                ...
                fn prop_symmetric_difference_distributive_with_intersection(
                    ...
                    let entries2: super::TypeErasedIndexSet = entries2;
                    let entries3: super::TypeErasedIndexSet = entries3;
                    super::prop_symmetric_difference_distributive_with_intersection::<$value_typ, $build_hasher_typ1, $build_hasher_typ2, $build_hasher_typ3, $alloc_typ>(entries1, entries2, entries3)?
                }
                ...
                fn prop_symmetric_difference_equals_union_of_differences(
                    ...
                    let entries1: super::TypeErasedIndexSet = entries1;
                    let entries2: super::TypeErasedIndexSet = entries2;
                    super::prop_symmetric_difference_equals_union_of_differences::<$value_typ, $build_hasher_typ1, $build_hasher_typ2, $alloc_typ>(entries1, entries2)?
                }
