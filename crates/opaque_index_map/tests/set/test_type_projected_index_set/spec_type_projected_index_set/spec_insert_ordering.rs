...
fn strategy_prop_insert_preserves_order_new_entry<T, S, A>(max_length: usize) -> impl Strategy<Value = (TypeProjectedIndexSet<T, S, A>, T)>
where
...
fn prop_insert_preserves_order_new_entry<T, S, A>((entries, new_entry): (TypeProjectedIndexSet<T, S, A>, T)) -> Result<(), TestCaseError>
where
