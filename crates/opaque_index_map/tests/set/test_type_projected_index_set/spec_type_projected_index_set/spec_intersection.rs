    ...
    A: any::Any + alloc::Allocator + Send + Sync + Clone,
{
    ...
    let rhs = from_union_in(
        &from_intersection_in(&entries1, &entries2),
        &from_intersection_in(&entries1, &entries3),
    );
...
fn prop_intersection_len1<T, S1, S2, A>(entries1: TypeProjectedIndexSet<T, S1, A>, entries2: TypeProjectedIndexSet<T, S2, A>) -> Result<(), TestCaseError>
where
    T: any::Any + Clone + Eq + hash::Hash + fmt::Debug,
    S1: any::Any + hash::BuildHasher + Send + Sync + Clone + Default,
    S1::Hasher: any::Any + hash::Hasher + Send + Sync,
...
fn prop_intersection_len2<T, S1, S2, A>(entries1: TypeProjectedIndexSet<T, S1, A>, entries2: TypeProjectedIndexSet<T, S2, A>) -> Result<(), TestCaseError>
where
    T: any::Any + Clone + Eq + hash::Hash + fmt::Debug,
    S1: any::Any + hash::BuildHasher + Send + Sync + Clone + Default,
    S1::Hasher: any::Any + hash::Hasher + Send + Sync,
...
fn prop_intersection_ordering<T, S1, S2, A>(entries1: TypeProjectedIndexSet<T, S1, A>, entries2: TypeProjectedIndexSet<T, S2, A>) -> Result<(), TestCaseError>
where
    T: any::Any + Clone + Eq + hash::Hash + fmt::Debug,
    S1: any::Any + hash::BuildHasher + Send + Sync + Clone + Default,
    S1::Hasher: any::Any + hash::Hasher + Send + Sync,
        ...
        mod $module_name {
            ...
            proptest! {
                ...
                fn prop_intersection_distributive_with_union(
                    ...
                    let entries2: super::TypeProjectedIndexSet<$value_typ, $build_hasher_typ2, $alloc_typ> = entries2;
                    let entries3: super::TypeProjectedIndexSet<$value_typ, $build_hasher_typ3, $alloc_typ> = entries3;
                    super::prop_intersection_distributive_with_union(entries1, entries2, entries3)?
                }
                ...
                fn prop_intersection_len1(
                    ...
                    let entries1: super::TypeProjectedIndexSet<$value_typ, $build_hasher_typ1, $alloc_typ> = entries1;
                    let entries2: super::TypeProjectedIndexSet<$value_typ, $build_hasher_typ2, $alloc_typ> = entries2;
                    super::prop_intersection_len1(entries1, entries2)?
                }
                ...
                fn prop_intersection_len2(
                    ...
                    let entries1: super::TypeProjectedIndexSet<$value_typ, $build_hasher_typ1, $alloc_typ> = entries1;
                    let entries2: super::TypeProjectedIndexSet<$value_typ, $build_hasher_typ2, $alloc_typ> = entries2;
                    super::prop_intersection_len2(entries1, entries2)?
                }
                ...
                fn prop_intersection_ordering(
                    ...
                    let entries1: super::TypeProjectedIndexSet<$value_typ, $build_hasher_typ1, $alloc_typ> = entries1;
                    let entries2: super::TypeProjectedIndexSet<$value_typ, $build_hasher_typ2, $alloc_typ> = entries2;
                    super::prop_intersection_ordering(entries1, entries2)?
                }
            }
        }
    };
