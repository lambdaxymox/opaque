...
fn bench_typed_proj_index_map_get_key_value(c: &mut Criterion) {
    let keys = 0..1000;
    let values = 1..1001;
...
criterion_group!(bench_get_key_value, bench_typed_proj_index_map_get_key_value, bench_index_map_get_key_value);
