...
fn bench_type_erased_index_set_swap_remove(c: &mut Criterion) {
    let values = 0..1000;
...
criterion_group!(bench_swap_remove, bench_type_erased_index_set_swap_remove, bench_index_set_swap_remove);
