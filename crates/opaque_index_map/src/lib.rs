...
pub struct Map<'a, K, V, S, A>
where
    A: any::Any + Allocator,
{
    map: &'a TypedProjIndexMap<K, V, S, A>,
}

impl<'a, K, V, S, A> Map<'a, K, V, S, A>
where
    K: any::Any,
    V: any::Any,
    S: any::Any + hash::BuildHasher,
...
{
    #[inline]
    const fn new(map: &'a TypedProjIndexMap<K, V, S, A>) -> Self {
        Self {
            map,
        }
    }
...
pub struct MapMut<'a, K, V, S, A>
where
    A: any::Any + Allocator,
{
    map: &'a mut TypedProjIndexMap<K, V, S, A>,
}

impl<'a, K, V, S, A> MapMut<'a, K, V, S, A>
where
    K: any::Any,
    V: any::Any,
    S: any::Any + hash::BuildHasher,
...
{
    #[inline]
    const fn new(map: &'a mut TypedProjIndexMap<K, V, S, A>) -> Self {
        Self {
            map,
        }
    }
...
impl OpaqueIndexMap {
    pub fn as_map<K, V, S, A>(&self) -> Map<'_, K, V, S, A>
    where
        K: any::Any,
        V: any::Any,
        S: any::Any + hash::BuildHasher,
        A: any::Any + Allocator,
    {
        ...
        Map::<K, V, S, A>::new(proj_self)
    }

    pub fn as_map_mut<K, V, S, A>(&mut self) -> MapMut<'_, K, V, S, A>
    where
        K: any::Any,
        V: any::Any,
        S: any::Any + hash::BuildHasher,
