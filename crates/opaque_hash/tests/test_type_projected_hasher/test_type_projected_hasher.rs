...
fn run_test_type_projected_hasher<T, I>(values: I)
where
    T: any::Any + hash::Hash,
    I: Iterator<Item = T>,
{
...
#[test]
fn test_type_projected_hasher_i8() {
    run_test_type_projected_hasher((i8::MIN..i8::MAX).into_iter());
}

#[test]
fn test_type_projected_hasher_i16() {
    run_test_type_projected_hasher((i16::MIN..i16::MAX).into_iter());
}

#[test]
fn test_type_projected_hasher_i32() {
    run_test_type_projected_hasher((i32::MIN..i32::MAX).step_by(i16::MAX as usize).into_iter());
}
...
#[test]
fn test_type_projected_hasher_u8() {
    run_test_type_projected_hasher((u8::MIN..u8::MAX).into_iter());
}

#[test]
fn test_type_projected_hasher_u16() {
    run_test_type_projected_hasher((u16::MIN..u16::MAX).into_iter());
}

#[test]
fn test_type_projected_hasher_u32() {
    run_test_type_projected_hasher((u32::MIN..u32::MAX).step_by(u16::MAX as usize).into_iter());
}
...
fn test_type_projected_hasher_usize() {
    run_test_type_projected_hasher((usize::MIN..usize::MAX).step_by((usize::MAX as usize) / (u16::MAX as usize)).into_iter());
}
