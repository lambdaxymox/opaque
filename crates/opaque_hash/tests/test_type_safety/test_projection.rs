use std::hash;
use opaque_hash::{TypedProjBuildHasher, OpaqueBuildHasher};
...
fn test_opaque_hasher_into_proj_correct_type1() {
    let opaque_build_hasher = OpaqueBuildHasher::new::<hash::RandomState>(hash::RandomState::new());
    let _ = opaque_build_hasher.into_proj::<hash::RandomState>();
}

#[test]
fn test_opaque_hasher_into_proj_correct_type2() {
    let opaque_build_hasher = OpaqueBuildHasher::new::<BuildZeroHasher>(BuildZeroHasher::new());
...
fn test_opaque_hasher_into_proj_correct_type3() {
    ...
    for _ in 0..65536 {
        ...
        opaque_build_hasher = OpaqueBuildHasher::from_proj(proj_build_hasher);
    }
}
