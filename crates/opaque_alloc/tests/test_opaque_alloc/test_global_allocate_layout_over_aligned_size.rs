...
#[cfg(feature = "nightly")]
fn run_test_opaque_alloc_allocate_size_with_layout_over_aligned_allocation<A>(opaque_alloc: TypeErasedAlloc, layout: alloc::Layout)
where
...
fn run_test_opaque_alloc_allocate_size_over_aligned_allocation_with_size_align<A>(alloc: A, size: usize, align: usize)
where
    A: any::Any + alloc::Allocator + Send + Sync,
{
    ...
    run_test_opaque_alloc_allocate_size_with_layout_over_aligned_allocation::<A>(opaque_alloc, layout);
}
...
fn test_opaque_alloc_allocate_size_over_aligned_allocation_with_size_1024_align_2048() {
    ...
    run_test_opaque_alloc_allocate_size_over_aligned_allocation_with_size_align(alloc,1024, 2048);
}
...
fn test_opaque_alloc_allocate_size_over_aligned_allocation_with_size_1024_align_4096() {
    ...
    run_test_opaque_alloc_allocate_size_over_aligned_allocation_with_size_align(alloc, 1024, 4096);
}
...
fn test_opaque_alloc_allocate_size_over_aligned_allocation_with_size_1024_align_8192() {
    ...
    run_test_opaque_alloc_allocate_size_over_aligned_allocation_with_size_align(alloc, 1024, 8192);
}
