    ...
    A: any::Any + alloc::Allocator + Clone,
{
    ...
    proj_blob_vec.replace_insert(0, initial_value_ptr);
...
macro_rules! generate_tests {
    ($typ:ident, $initial_value:expr, $value:expr) => {
        mod $typ {
            ...
            #[test]
            fn test_typed_proj_blob_vec_replace_insert_get_same_index1() {
                let value: $typ = $value;
                let alloc = alloc::Global;
                run_test_typed_proj_blob_vec_replace_insert_get_same_index1(value, alloc);
            }

            #[test]
            fn test_typed_proj_blob_vec_replace_insert_get_same_index2() {
                let initial_value = $initial_value;
                let value: $typ = $value;
                let alloc = alloc::Global;
                run_test_typed_proj_blob_vec_replace_insert_get_same_index2(initial_value, value, alloc);
            }
        }
    };
}
