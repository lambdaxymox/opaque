...
fn bench_opaque_blob_vec_shift_remove_last(c: &mut Criterion) {
    let dummy_data = 0_i32;
        ...
        b.iter_batched(
            ...
            |mut opaque_blob_vec| {
                for _ in 0..opaque_blob_vec.len() {
                    ...
                    let _ = core::hint::black_box(opaque_blob_vec.shift_remove_forget_unchecked::<alloc::Global>(last_index));
                }
            },
            criterion::BatchSize::NumIterations(1000),
        );
...
criterion_group!(bench_shift_remove_forget_unchecked, bench_opaque_blob_vec_shift_remove_last, bench_vec_shift_remove_last);
