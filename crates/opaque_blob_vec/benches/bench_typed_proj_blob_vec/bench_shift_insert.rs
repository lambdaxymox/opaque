...
fn bench_typed_proj_blob_vec_shift_insert_last(c: &mut Criterion) {
    let dummy_data = 0_i32;

    c.bench_function("typed_proj_blob_vec_shift_insert_last", |b| {
        b.iter(|| {
...
criterion_group!(bench_shift_insert, bench_typed_proj_blob_vec_shift_insert_last, bench_vec_shift_insert_last);
